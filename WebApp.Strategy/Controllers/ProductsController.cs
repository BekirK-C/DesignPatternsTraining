...
namespace WebApp.Strategy.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _productRepository.GetAllByUserId(user.Id)); // Değişikliği dene !!!
            //await _productRepository.GetAllByUserId(user.Id);
            //return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Price,Stock,UserId,CreatedTime")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
